 ...
 */
final class Version20250930154421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enchere_utilisateur (id INT AUTO_INCREMENT NOT NULL, lot_id INT NOT NULL, utilisateur_id INT NOT NULL, montant DOUBLE PRECISION NOT NULL, cree_le DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_4AD5E89DA8CBA5F7 (lot_id), INDEX IDX_4AD5E89DFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lot (id INT AUTO_INCREMENT NOT NULL, evenement_enchere_id INT NOT NULL, gagnant_id INT DEFAULT NULL, lot VARCHAR(255) DEFAULT NULL, categorie VARCHAR(255) DEFAULT NULL, paiement DOUBLE PRECISION DEFAULT NULL, facture VARCHAR(255) DEFAULT NULL, image_filename VARCHAR(255) DEFAULT NULL, prix_depart DOUBLE PRECISION NOT NULL, increment_min DOUBLE PRECISION NOT NULL, INDEX IDX_B81291B1971D2B5 (evenement_enchere_id), INDEX IDX_B81291B2F942B8 (gagnant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
